...
test("How It Works presents the six recorded Linkdo workflows", async () => {
  ...
  for (const video of [
    "/videos/how-it-works/01-categories.mp4",
    "/videos/how-it-works/02-plan.mp4",
    "/videos/how-it-works/03-notion.mp4",
    "/videos/how-it-works/04-focus.mp4",
    "/videos/how-it-works/05-reports.mp4",
    "/videos/how-it-works/06-theme.mp4",
  ]) {

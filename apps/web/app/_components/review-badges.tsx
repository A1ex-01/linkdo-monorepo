...
export function ReviewBadges() {
  return (
    <section id="reviews" className="px-5 pb-[72px] pt-2">
      <p className="mb-6 text-center text-[13px] text-[#858585]">深受全球高效工作者信赖与好评</p>
      <div className="mx-auto flex max-w-[740px] flex-wrap items-center justify-center gap-3">
        <Badge href="#reviews" label="Linkdo 在 GetApp 上的评价" className="w-[104px]">
        ...
        <Badge href="#reviews" label="Linkdo 社区评分" className="w-[130px]">
          <div className="text-center leading-none"><strong className="text-[11px]">社区评分</strong><span className="mt-2 block text-[12px] text-[#ef7162]">★★★★★</span></div>
        </Badge>
        <Badge href="https://www.softwareadvice.com/product/519553-Linkdo/reviews/" label="Linkdo 在 Software Advice 上的评价" className="w-[129px]">
        ...
        <Badge href="https://www.capterra.com/p/10020211/Linkdo/reviews/" label="Linkdo 在 Capterra 上的评价" className="w-[128px]">
        ...
        <Badge href="#reviews" label="Linkdo 登上 Tool Finder" className="h-[110px] w-[150px] flex-col">

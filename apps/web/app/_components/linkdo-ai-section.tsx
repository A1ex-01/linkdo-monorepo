    ...
    <article className="linkdo-card noise relative min-h-[882px] p-5 md:min-h-[882px]">
      ...
      <div className="absolute inset-x-8 bottom-8 top-[130px] overflow-hidden rounded-[24px] border border-[#d96ee6] bg-[#171717]">
        <Image
          ...
          src="http://static.a1ex.online/linkdo/images/XGrZiuZ78TIqjAdDetbAOVSfQQ.png"
          alt=""
          width={906}
          height={648}
        />
        ...
        <Image
          ...
          src="http://static.a1ex.online/linkdo/images/z8fxe3EBvisaVsY8ekUwIYeY.png"
          alt="Linkdo AI"
          width={512}
          height={512}
        />
  ...
  return (
    <article className="linkdo-card noise relative min-h-[282px] p-5">
      ...
      <Image
        ...
        src="http://static.a1ex.online/linkdo/images/yBUdr1WdCqmE37TI8HHsGhq7SZc.png"
  ...
  return (
    <article className="linkdo-card noise relative min-h-[566px] p-5">
      ...
      <Image
        ...
        src="http://static.a1ex.online/linkdo/images/sd1l1foDOqBlOYHlAfs5rrUVN4o.png"
        alt=""
        width={2042}
        height={1984}
      />

...
The OMX runtime owns orchestration. The `harness/` layer owns project boundaries, artifact contracts, verification gates, and migration portability.
...
When this AGENTS.md is regenerated, preserve this overlay or reapply it from `harness/README.md`.
...
- Workers escalate shared-file conflicts, scope expansion, or missing ownership conflicts to the leader instead of freelancing.
